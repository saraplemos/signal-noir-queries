...
export const MODE2_USER_PROMPT = (queries) => `Answer each luxury travel query below as you would for a real traveler. After each answer, list the specific sources you referenced or would cite.
